// class updated by Thomas Pearson
#ifndef RBTREE_H_
#define RBTREE_H_
...
protected:
	...
	RBTreeNode<T>* copyTree(RBTreeNode<T>*, RBTreeNode<T>*);
	bool checkEqual(RBTreeNode<T>*, RBTreeNode<T>*, RBTreeNode<T>*);
 ...
 * Parameters: RBTreeNode<T>* nodePtr, RBTreeNode<T>* nodeNIL
 * Return Type: RBTreeNode<T>*
*/
template<class T>
RBTreeNode<T>* RBTree<T>::copyTree(RBTreeNode<T>* nodePtr, RBTreeNode<T>* nodeNIL) {
	if (nodePtr == nodeNIL)
		return NIL;
 ...
 * Parameters: RBTree<T> & rhs
 * Return Type: bool
*/
template <class T>
bool RBTree<T>::operator==(RBTree<T> & rhs) {
 ...
 * Parameters: RBTreeNode<T>* nodePtr, RBTreeNode<T>* obj, RBTreeNode<T>* nodeNIL
 * Return Type: bool
*/
template <class T>
bool RBTree<T>::checkEqual(RBTreeNode<T>* nodePtr, RBTreeNode<T>* obj, RBTreeNode<T>* nodeNIL) {

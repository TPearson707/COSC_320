...
/*
 * Description: takes an array and calls the insert function to fill the binary tree in a sorted manner
 * Parameters: int* arr, int n
 * Return Type: void
 */
void IntBinaryTree::loadArray(int* arr, int n) {
...
/*
 * Description: Driver function for fillArray(int*, int); does a recursive inorder traversal of the tree and loads the array while doing so.
 * Parameters: TreeNode* nodePtr, int* arr, int n
 * Return Type: void
 */
void IntBinaryTree::fillArray(TreeNode* nodePtr, int* arr, int n, int &counter) {

	if (nodePtr) {
		fillArray(nodePtr->left, arr, n, counter);
		arr[counter++] = nodePtr->value;
		fillArray(nodePtr->right,arr, n, counter);
	}
}

/*
 * Description: helper function for fillArray(TreeNode*, int*, int)
 * Parameters: int* arr, int n
 * Return Type: void
 */
void IntBinaryTree::fillArray(int* arr, int n) {
	if (!root)
		return;
	...
	fillArray(nodePtr, arr, n, counter);
}

...
// Counting functions
template <class T> long count (T* begin, T* end, const T& val, auto fctPtr);
template <class T> long count (typename vector<T>::iterator begin, typename vector<T>::iterator end, const T& val, auto fctPtr);
